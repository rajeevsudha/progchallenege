...
int main()
{
  ...
  outfile.open("110103.oup",ios::out);
  int i,j;
  ...
  while(infile>>n)
      ...
      if(sum%n==0)
	{
	  ...
	  outfile<<setiosflags(ios::fixed | ios::showpoint)<<setprecision(2)<<"$"<<exch/100<<"\n";
	}
      else
	{
	  ...
	  if(exch1>exch2)
		 outfile<<setiosflags(ios::fixed | ios::showpoint)<<setprecision(2)<<"$"<<exch1/100<<"\n";
	  else
	  	 outfile<<setiosflags(ios::fixed | ios::showpoint)<<setprecision(2)<<"$"<<exch2/100<<"\n";
